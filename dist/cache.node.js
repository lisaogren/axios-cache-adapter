...
function () {
  function RedisStore(client) {
    ...
    if (lodash_get__WEBPACK_IMPORTED_MODULE_5___default()(client, 'constructor.name') !== 'RedisClient') {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                return _context6.abrupt("return", Promise.all(lodash_map__WEBPACK_IMPORTED_MODULE_4___default()(hashData, function (value, key) {
                  return fn(value, key);
                })));
